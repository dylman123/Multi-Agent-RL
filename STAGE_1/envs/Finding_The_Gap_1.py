...
specials = [(1, (6, 0), "green", 5), (2, (0, 1), "green", 5), (2, (1, 0), "red", -5), (2, (0, 0), "red", -5)]
...
'''
init_state = (0, 0, 6, 1)
env = Grid_World(width=7, height=2, initial_state=init_state, walls=walls, specials=specials)
